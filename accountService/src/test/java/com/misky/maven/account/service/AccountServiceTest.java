...
public class AccountServiceTest {
    ...
    public void prepare() throws Exception {
        ...
        greenMail.setUser("test@misky.com","123456");
        greenMail.start();
    ...
    public void testAccountService() throws Exception {
        ...
        signUpRequest.setId("misky");
        signUpRequest.setEmail("test2@misky.com");
        signUpRequest.setName("misky");
        ...
        try {
            accountService.login("misky", "admin");
        ...
        try {
            accountService.login("misky", "admin1");
